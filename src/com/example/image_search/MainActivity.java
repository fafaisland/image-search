...
public class MainActivity extends Activity {
    ...
    private class SearchImage extends AsyncTask<String,Void,List<Bitmap>>{
        ...
        protected List<Bitmap> doInBackground(String...params) {
            ...
            try {
                ...
                for (VelvetImage image : imageList){
                  String uri = image.getThumbnailUri();
                  Bitmap r = ImageSearch.download(uri);
                  result.add(r);
                }
